...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        this.formno = formno;
        setLayout(null); // this line for working of setBounds
        ...
        r2 = new JRadioButton("Fixed Accound");
        r2.setFont(new Font("Raleway", Font.BOLD, 16));
        r2.setBounds(350, 180, 160, 20);
        add(r2);
        ...
        ButtonGroup groupaacount = new ButtonGroup();
        groupaacount.add(r1);
        groupaacount.add(r2);
        groupaacount.add(r3);
        groupaacount.add(r4);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            if (r1.isSelected()) {
                ...
                accounType = "Reccurring Deposit Account";
            }
            ...
            try {
                if (ae.getSource() == submit) {
                    ...
                    if (accounType.equals("")) {
                        ...
                        Conn conn = new Conn();
                        String query1 = "insert into signupthree values('" + formno + "','" + accounType + "','"
